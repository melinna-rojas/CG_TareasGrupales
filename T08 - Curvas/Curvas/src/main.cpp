...
ptCtrl c03[4] = {{0.560, 0.757}, {0.540, 0.747}, {0.539, 0.787}, {0.559, 0.784}}; // Pupila izquierda
ptCtrl c04[4] = {{0.560, 0.757}, {0.581, 0.753}, {0.580, 0.790}, {0.559, 0.784}}; // Pupila izquierda
...
ptCtrl c07[4] = {{0.778, 0.752}, {0.755, 0.742}, {0.757, 0.784}, {0.775, 0.776}}; // Pupila derecha
ptCtrl c08[4] = {{0.775, 0.776}, {0.792, 0.784}, {0.792, 0.745}, {0.778, 0.752}}; // Pupila derecha
