...
ptCtrl c19[4] = {{0.6691, 0.8452}, {0.7043, 0.9391}, {0.8570, 0.9391}, {0.8804, 0.8100}}; //ojo derecho
ptCtrl c20[4] = {{0.7630, 0.6457}, {0.8217, 0.6457}, {0.8922, 0.6809}, {0.8804, 0.8100}}; //ojo derecho
ptCtrl c29[4] = {{0.8100, 0.6515}, {0.8100, 0.6515}, {0.8804, 0.5635}, {0.8804, 0.5635}}; //Boca
ptCtrl c30[4] = {{0.4343, 0.5048}, {0.5870, 0.4109}, {0.8217, 0.4285}, {0.8804, 0.5670}}; //
ptCtrl c32[4] = {{0.4226, 0.4813}, {0.4226, 0.4813}, {0.4461, 0.5283}, {0.4461, 0.5283}}; //
ptCtrl c31[4] = {{0.3874, 0.5165}, {0.2817, 0.4637}, {0.2817, 0.6633}, {0.3874, 0.6104}}; //Oreja
ptCtrl c28[4] = {{0.3404, 0.5400}, {0.3052, 0.5635}, {0.3404, 0.5987}, {0.3639, 0.5752}}; //Oreja
ptCtrl c33[4] = {{0.3522, 0.5048}, {0.3639, 0.4343}, {0.3580, 0.4109}, {0.3522, 0.3522}}; //Cuello
ptCtrl c34[4] = {{0.2817, 0.5048}, {0.2817, 0.5048}, {0.2817, 0.4226}, {0.2817, 0.4226}}; //Cabello
ptCtrl c35[4] = {{0.2817, 0.4226}, {0.2817, 0.4226}, {0.3580, 0.4226}, {0.3580, 0.4226}}; //Cabello
ptCtrl c36[4] = {{0.6691, 0.4461}, {0.6457, 0.4109}, {0.6104, 0.4226}, {0.6104, 0.3991}}; //Menton
ptCtrl c37[4] = {{0.6104, 0.3991}, {0.5870, 0.3522}, {0.5870, 0.3287}, {0.5752, 0.2935}}; //cuello
//Ojo 2 (Completo)
ptCtrl c38[4] = {{0.3991, 0.8452}, {0.3991, 0.8452}, {0.4343, 0.8217}, {0.4343, 0.8217}}; //Pestañas
ptCtrl c39[4] = {{0.4461, 0.9391}, {0.4461, 0.9391}, {0.4696, 0.9039}, {0.4696, 0.9039}}; //Pestañas
ptCtrl c40[4] = {{0.5283, 0.9743}, {0.5283, 0.9763}, {0.5400, 0.9391}, {0.5400, 0.9391}}; //Pestañas
ptCtrl c41[4] = {{0.6104, 0.9274}, {0.6104, 0.9274}, {0.6222, 0.9626}, {0.6222, 0.9626}}; //Pestañas
//Ojo 2
ptCtrl c42[4] = {{0.7630, 0.9098}, {0.7630, 0.9098}, {0.7748, 0.9450}, {0.7748, 0.9450}}; //Pestañas
ptCtrl c43[4] = {{0.8217, 0.8922}, {0.8217, 0.8922}, {0.8452, 0.9274}, {0.8452, 0.9274}}; //Pestañas
ptCtrl c44[4] = {{0.8687, 0.8452}, {0.8687, 0.8452}, {0.9039, 0.8804}, {0.9039, 0.8804}}; //Pestañas
ptCtrl c45[4] = {{0.8840, 0.7865}, {0.8840, 0.7865}, {0.9239, 0.8100}, {0.9239, 0.8100}}; //Pestañas
ptCtrl c26[4] = {{0.2817, 0.5048}, {0.1174, 0.5048}, {0.1174, 0.5048}, {0.2358, 0.7043}}; //PELO
ptCtrl c27[4] = {{0.2348, 0.7043}, {0.0822, 0.8217}, {0.0822, 0.8217}, {0.2348, 0.9391}}; //PELO
ptCtrl c25[4] = {{0.2348, 0.9391}, {0.2113, 1.1152}, {0.1526, 1.1152}, {0.3522, 1.1504}}; //ARRIBA
ptCtrl c24[4] = {{0.3522, 1.1504}, {0.4696, 1.3500}, {0.4109, 1.3500}, {0.5635, 1.2326}}; //PELO
ptCtrl c23[4] = {{0.5635, 1.2326}, {0.7043, 1.3500}, {0.6457, 1.3500}, {0.7748, 1.1739}}; //OREJA
ptCtrl c22[4] = {{0.7748, 1.1739}, {0.9391, 1.1504}, {0.8804, 1.1504}, {0.8804, 0.9978}};
ptCtrl c21[4] = {{0.8804, 0.9978}, {0.9743, 0.9157}, {0.9743, 0.9157}, {0.8804, 0.8100}};
ptCtrl c50[4] = {{0.53923, 0.77842}, {0.51931, 0.76846}, {0.51793, 0.80842}, {0.53822, 0.80504}}; //Ojito izquierdo
ptCtrl c51[4] = {{0.53923, 0.77842}, {0.55968, 0.77372}, {0.55862, 0.81132}, {0.53822, 0.80504}};
ptCtrl c52[4] = {{0.77662, 0.78328}, {0.75692, 0.77248}, {0.75867, 0.81398}, {0.77562, 0.80638}}; //Ojito derecho
ptCtrl c53[4] = {{0.77562, 0.80638}, {0.79433, 0.81398}, {0.79374, 0.77482}, {0.77662, 0.78328}};
//Collar
ptCtrl c54[4] = {{0.32446, 0.27672}, {0.28175, 0.30582}, {0.30738, 0.35814}, {0.35089, 0.35066}}; //Ojo Completo
ptCtrl c55[4] = {{0.35089, 0.35066}, {0.40054, 0.32878}, {0.37384, 0.26631}, {0.32446, 0.27672}};
//Segundo circulo
ptCtrl c56[4] = {{0.39386, 0.25377}, {0.35329, 0.29194}, {0.38799, 0.34052}, {0.43257, 0.32664}}; //Ojo Completo
ptCtrl c57[4] = {{0.43257, 0.32664}, {0.47421, 0.29754}, {0.44271, 0.23909}, {0.39386, 0.25377}};
//Tercer collar
ptCtrl c58[4] = {{0.47603, 0.23759}, {0.42823, 0.25309}, {0.4376, 0.31704}, {0.49057, 0.31284}}; //Ojito derecho
ptCtrl c59[4] = {{0.49057, 0.31284}, {0.53966, 0.29896}, {0.52448, 0.23985}, {0.47603, 0.23759}};
//Cuarto collar
ptCtrl c60[4] = {{0.54773, 0.22596}, {0.50801, 0.23565}, {0.51059, 0.29024}, {0.55516, 0.29734}}; //Ojito derecho
ptCtrl c61[4] = {{0.55516, 0.29734}, {0.59909, 0.28765}, {0.5936, 0.23016}, {0.54773, 0.22596}};
//5t0
ptCtrl c62[4] = {{0.56679, 0.29443}, {0.65594, 0.32318}, {0.63882, 0.19592}, {0.56679, 0.23242}};
...
void init(GLFWwindow *window)
{
    ...
    //Grado de la curva de Bezier, número de puntos para la curva
...
int main(void)
{
    ...
    GLFWwindow *window = glfwCreateWindow(600, 600, "T08 - Curvas", NULL, NULL);
